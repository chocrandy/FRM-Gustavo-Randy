...
{
    public partial class mantenimiento_monedas : Form
    {
        string usuario = "";        
        public mantenimiento_monedas(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod Moneda", "Moneda", "Estado" }; // Arreglo de nombres para campos
            ...
            navegador1.asignarTabla("monedas"); // tabla principal
            navegador1.asignarNombreForm("Monedas"); // Titulo y nombre del form
        }
